...
Namespace Series_OverlappedGanttChart
    Partial Public Class Form1
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
            ...
            ' Add points to them.
            series1.Points.Add(New SeriesPoint("Market analysis", New Date() { _
                New Date(2006, 8, 16), _
                New Date(2006, 8, 23) _
            }))
            series1.Points.Add(New SeriesPoint("Feature planning", New Date() { _
                New Date(2006, 8, 23), _
                New Date(2006, 8, 26) _
            }))
            series1.Points.Add(New SeriesPoint("Implementation", New Date() { _
                New Date(2006, 8, 26), _
                New Date(2006, 9, 26) _
            }))
            series1.Points.Add(New SeriesPoint("Testing & bug fixing", New Date() { _
                New Date(2006, 9, 26), _
                New Date(2006, 10, 10) _
            }))

            series2.Points.Add(New SeriesPoint("Market analysis", New Date() { _
                New Date(2006, 8, 16), _
                New Date(2006, 8, 23) _
            }))
            series2.Points.Add(New SeriesPoint("Feature planning", New Date() { _
                New Date(2006, 8, 23), _
                New Date(2006, 8, 26) _
            }))
            series2.Points.Add(New SeriesPoint("Implementation", New Date() { _
                New Date(2006, 8, 26), _
            ...
            ' Add a progress line.
            Dim progress As New ConstantLine("Current progress", New Date(2006, 9, 10))
